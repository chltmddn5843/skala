    ...
    <div class="page-layout">
      ...
      <main class="main-content">
        ...
        <div class="profile-card fade-in-up">
          ...
          <div class="profile-info">
            ...
            <span class="badge" :class="isInstructor ? 'badge-amber' : 'badge-blue'">
              {{ isInstructor ? '제조·공급사' : '의료기관 구매 담당자' }}
            </span>
          </div>
        </div>
        ...
        <section v-if="!isInstructor" class="recommend-section">
          <h3 class="section-title">추천 의료장비</h3>
        ...
        <section v-else class="instructor-section">
          <div class="section-head">
            <h3 class="section-title">내가 등록한 의료장비</h3>
            <span class="section-subtitle">등록 장비와 장비별 도입 의료기관 수를 확인할 수 있습니다.</span>
          </div>

          <div class="summary-cards">
            <div class="summary-card">
              <div class="summary-label">등록 장비 수</div>
              <div class="summary-value">{{ myCourses.length }}</div>
            </div>
            <div class="summary-card">
              <div class="summary-label">총 도입 기관 수</div>
...
async function loadStudentRecommendations() {
  try {
    if (!auth.user) {
      ...
      recommendError.value = '추천 의료장비를 준비 중입니다.'
      return
    }
    ...
    recommendError.value = '현재 추천 의료장비를 불러오지 못했습니다. 잠시 후 다시 시도해 주세요.'
  } finally {
...
async function loadInstructorCourses() {
  try {
    if (!auth.user) {
      ...
      instructorError.value = '장비 정보를 불러오지 못했습니다.'
      return
    }
