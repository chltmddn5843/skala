  ...
  <div class="page-wrapper">
    ...
    <div class="page-layout">
      ...
      <main class="main-content">
        <h1 class="page-title">의료장비 도입 내역</h1>
        ...
        <div v-else-if="enrollments.length" class="enrollment-list fade-in">
          <div v-for="item in enrollments" :key="item.id" class="enrollment-card">
            ...
            <div class="enroll-info">
              ...
              <p class="enroll-instructor">제조·공급사: {{ item.course?.instructorName || '정보 없음' }}</p>
            </div>
            ...
            <div class="enroll-status">
              ...
              >
                {{ item.status === 'ACTIVE' ? '도입 완료' : '결제 대기' }}
              </span>
...
const categoryConfig = {
  '진단장비': { bg: 'thumb-teal', badge: 'badge-teal', thumb: 'spring_boot' },
  '환자 모니터링': { bg: 'thumb-teal', badge: 'badge-teal', thumb: 'vue_js' },
  '수술장비': { bg: 'thumb-blue', badge: 'badge-blue', thumb: 'kubernetes' },
  '검사장비': { bg: 'thumb-purple', badge: 'badge-purple', thumb: 'python' },
  '디지털 헬스': { bg: 'thumb-pink', badge: 'badge-pink', thumb: 'generative_ai' },
}
