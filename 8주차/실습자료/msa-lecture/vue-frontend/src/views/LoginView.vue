  ...
  <div class="login-page">
    <div class="login-layout">
      ...
      <div class="login-left">
        <div class="brand">
          <img src="@/assets/images/logo/main_logo.png" alt="MediEquip" class="brand-logo" />
          <span class="brand-name">MediEquip</span>
        </div>
        <div class="brand-content">
          <h2>다시 만나서<br>반갑습니다</h2>
          <p>의료기관과 장비 공급사를 연결하는 도입 업무를 시작하세요.</p>
      ...
      <div class="login-right">
        <div class="login-box fade-in-up">
          ...
          <div v-if="!showRegister" class="section">
            ...
            <p class="section-desc">MediEquip 기업 계정으로 로그인합니다.</p>
            ...
            <form @submit.prevent="handleRegister" class="form">
              ...
              <div class="form-group">
                ...
                <select v-model="registerForm.role" class="form-input">
                  <option value="STUDENT">의료기관 구매 담당자</option>
                  <option value="INSTRUCTOR">의료장비 제조·공급사</option>
                </select>
              </div>
...
const features = ['의료장비 통합 비교', '간편한 구매·결제 처리', '도입 이력 기반 장비 추천']
